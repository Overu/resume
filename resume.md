...
- 基于小程序的技术栈，通过使用Gulp增加编译层以实现模块的隔离、模块生命周期、模块编译、配置解析和代码注入等
- 改造开发、测试流程，极大提高效率
...
- 基于pnpm、TypeScript、Vue、vite、esbuild、swc、postCSS等，从零搭建现代化的工程体系
- 前端负责人和主程序员
...
## 宁波华鼐时空网络科技有限公司 (2017.09 ~ 2020.03)
### vsmap
...
### Android 2D地图渲染引擎
- 2D地图渲染SDK，对GeoJSON数据解析渲染，提供丰富的接口进行交互
